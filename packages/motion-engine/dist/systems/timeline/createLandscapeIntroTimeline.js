...
export function createLandscapeIntroTimeline(deps) {
    ...
    tl.fromTo(deps.titleObject.position, { y: 4.4 }, { y: 4.0, duration: 2.2, ease: "power2.out" }, 4);
    tl.to(deps.titleObject.position, { y: 3.85, duration: 0.8, ease: "back.out(2)" }, 6.1);
    tl.to(deps.titleObject.position, { y: 3.92, duration: 3.0, ease: "sine.inOut", repeat: -1, yoyo: true }, 7.0);
    tl.pause(0);
    return tl;
}
