...
const WRITING_CAPABILITIES = {
  ...
  "PROPOSE_DRAFT": writingManifest(
    ...
    "DELEGATED",
    "HIGH",
    "Write requested draft text directly into the document, with a visible result and undo.",
    ["inserts an editable manuscript block with a reversible operation"],
    ["UNDO", "SUPERSEDE"],
  ),
  "PROPOSE_REWRITE": writingManifest(
    "quipsly.writing.rewrite.propose",
    "Rewrite a writing block",
    "DELEGATED",
    "HIGH",
    "Perform a requested rewrite of editable writing, retaining the prior text for undo.",
    ["replaces editable text only while its exact source version still matches", "never rewrites original recording or research evidence"],
    ["UNDO", "SUPERSEDE"],
  ),
  ...
  "PROPOSE_CONTINUITY_FIX": writingManifest(
    ...
    "Repair writing continuity",
    "DELEGATED",
    "HIGH",
    "Perform a requested continuity repair with a visible result and undo.",
    ["replaces editable text only while its exact source version still matches"],
    ["UNDO", "SUPERSEDE"],
  ),
