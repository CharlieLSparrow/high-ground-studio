...
- `promising-needs-polish`: `5`
- `strong-post-candidate`: `7`
...
- Next: Add or approve a readable caption/overlay plan.
- Missing: `caption-or-overlay-plan`
...
script/agentctl.sh shorts-select id 'FC28A75E-451B-4D74-9636-2E842805F106' && script/agentctl.sh shorts-update-selected hook 'Replace with a sharper opening hook.'
...
- Tier: `promising-needs-polish`
- Stage: `exported-needs-listen-through`
- Next: Write a sharper opening hook before packaging.
- Missing: `hook, caption-or-overlay-plan`
