...
| `values` | none yet | none yet | `apps/web/content/_staging/learning-to-lead/episodes/values` | `apps/web/content/_inbox/Podcast Year 1/5 - April 22 - Values` | `apps/web/content/episodes/learning-to-lead/values/packet.mdx` | Medium | The packet is now canonical, but there is still no public derivative. Scott has a selected main draft, Charlie exists in both a stronger sidebar file and a partial standalone file, and the dossier is rich production support. The main ambiguity is whether future public packaging stays `Values` or leans into `The Values Toolkit`, plus how Charlie should be shaped for any later public sync. |
| `be-where-you-are` | none yet | none yet | `apps/web/content/_staging/learning-to-lead/episodes/be-where-you-are` | `apps/web/content/_inbox/Podcast Year 1/9 - May 20 - Be Where You Are` | `apps/web/content/episodes/learning-to-lead/be-where-you-are/packet.mdx` | Medium | The packet is now canonical and packet-only. Scott has a selected main draft and the research stack is rich, but Charlie prose is still absent: both staging and inbox `Charlie.md` files are empty. The main ambiguity is whether future public packaging should stay `Be Where You Are` or split the stronger sub-arcs (`The Shower Strategy`, `Leading from the Right`, `The Adult in the Room`) into a different public shape. |
