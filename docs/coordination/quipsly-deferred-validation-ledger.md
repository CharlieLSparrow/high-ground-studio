...
| Pending | A coach reviews a real two-person transcript against protected playback: beginning/middle/ending word highlighting, participant attribution, one wording correction, one speaker correction or confirmation, refresh, cross-device readback, and a reversible transcript-based trim preview. | RecordingAsset, transcript job, segment/word, correction/verification, speaker-attribution, and edit-proposal identities; observed source-clock alignment; retained provider evidence; effective corrected readback; unchanged source bytes; and explicit proof that preview did not silently mutate the canonical timeline. |
