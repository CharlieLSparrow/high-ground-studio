    ...
    >
      ...
      <form onSubmit={handleSubmit} className="p-5 space-y-4">
        ...
        <div>
          ...
          >
            <option value="CHARACTER">Character / Person / Figure</option>
            <option value="SETTING">Setting / Location / Venue</option>
            <option value="SCENE">Scene / Segment / Episode</option>
