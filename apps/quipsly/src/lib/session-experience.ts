...
const EXPERIENCES: Record<SessionExperience["purpose"], SessionExperience> = {
  COACHING: {
    ...
    liveHeading: "Meet with your coaching team from any device",
    liveDescription: "Use a studio microphone or camera in the browser while another participant joins from iPhone Capture. Private notes, transcript review, goals, and client-safe follow-up remain bound to this Session.",
