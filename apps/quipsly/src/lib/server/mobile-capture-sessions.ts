...
function transcriptResultSource(value: unknown, roomId: string, transcriptJobId: string) {
...
/**
 * Project the ordinary work Quipsly already created from a transcript back
 * into the Session. This is the primary result surface; provenance remains a
 * useful backlink, never a second approval queue.
 */
export function mobileTranscriptResults(input: {
  roomId: string;
