...
import { Columns2, Columns3, Columns4, Settings, Plus, Download, LayoutTemplate, PanelLeft, BookOpen } from "lucide-react";
...
export function StoryboardDeskClient({ initialShots }: { initialShots: StoryboardShot[] }) {
  ...
  return (
    <main className="min-h-screen p-3.5 md:p-6 bg-[#030404] flex flex-col lg:flex-row gap-[18px]">
      ...
      {showScript && (
        <aside className="hidden lg:flex w-[400px] xl:w-[500px] flex-col gap-[18px]">
