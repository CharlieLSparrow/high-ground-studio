...
const roles = [
  ...
  },
  {
    ...
    Icon: BookOpen,
    image: "/images/quipsly-generated/quipsly_teaching_nature_exploration.webp",
  ...
  },
  {
    ...
    Icon: Palette,
    image: "/images/quipsly-generated/cute_quipsly_inventor_drawing_machine.webp",
  ...
  },
  {
    ...
    Icon: Library,
    image: "/images/quipsly-generated/quipsly_photographer_navigator_adventure.webp",
          ...
          <div className="grid gap-10 p-7 md:p-12 lg:grid-cols-[1fr_420px]">
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-[2.5rem] border border-[#dbc295] bg-white p-3 shadow-xl">
                <Image src="/images/quipsly-generated/curious_quipsly_holding_magnifier.webp" alt="A curious Quipsly holding a magnifier" width={720} height={720} priority className="aspect-square w-full rounded-[2rem] object-cover" />
              </div>
            </div>
          </div>
        </header>
