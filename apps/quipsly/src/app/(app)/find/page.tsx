  ...
  try {
    ...
    return <main className="mx-auto max-w-7xl space-y-6 px-1 py-4 text-foreground">
      <header className="rounded-[2rem] border border-border bg-card p-6 shadow-sm md:p-8">
        ...
        <p className="mt-3 max-w-3xl text-sm font-semibold leading-6 text-muted-foreground">{focusedTag ? `Work tagged #${focusedTag.resolvedLabel} in ${focusedTag.project.name}.` : "Find your notes, tasks, sessions, sources, and shared work."}</p>
