...
export default function AdSenseBannerSlot({ slotId, format = "auto" }: AdSenseBannerSlotProps) {
  ...
  if (!isEnabled || !adsenseClient) {
    return (
      <div className="flex flex-col items-center justify-center p-6 border border-teal-500/10 bg-teal-500/5 rounded-xl min-h-[120px] text-center font-mono">
        <span className="text-xs text-teal-450 font-semibold uppercase tracking-wider mb-1">AdSlot Placeholder</span>
  ...
  return (
    <div className="w-full flex justify-center py-4 overflow-hidden min-h-[100px] border border-slate-900 bg-black/10 rounded-xl">
      <ins
