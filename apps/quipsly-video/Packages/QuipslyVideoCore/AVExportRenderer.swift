                ...
                for instruction in instructions {
                    if let layerInstructions = instruction.layerInstructions as? [AVMutableVideoCompositionLayerInstruction] {
                        ...
                        for layerInstruction in layerInstructions {
                            ...
                            var transform = CGAffineTransform(translationX: -420 + initialFrame.offsetX, y: 420 + initialFrame.offsetY)
                            transform = transform.scaledBy(x: initialFrame.scale, y: initialFrame.scale)
