    ...
    <section className="space-y-8">
      ...
      <div className="rounded-2xl border border-amber-200/20 bg-amber-200/10 px-4 py-3 text-sm leading-6 text-amber-50">
        <div className="flex gap-3">
          ...
          />
          <p className="m-0">
            This page is intentionally team-only. Future agents should add a
            short entry when they land a meaningful commit, merge, or deploy so
            Homer, Mako, Melissa, and the rest of the team can follow the work
            without reading terminal transcripts.
          </p>
        </div>
      </div>
