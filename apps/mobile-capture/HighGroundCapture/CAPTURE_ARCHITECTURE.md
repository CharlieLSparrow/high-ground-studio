...
- Promotion: one idempotent, transaction/lock-protected path creates the canonical Studio attachment only after processing release; upload must not create one asset and promotion create another.
