...
| App Store draft visual QA | exact committed source `58c57250`, detached iPhone 17 Pro Max / iOS 26.3.1 screenshot run, human inspection, and focused UI rerun | PASS — five private-data-safe 1320 x 2868 drafts exposed and repaired a truncated Calendar action, ambiguous upload-policy labels, and contradictory local-source count; final 2/2 UI result at `/tmp/quipsly-capture-app-store-ux-fix-rerun-20260803T035737Z-50848.xcresult`; drafts remain upload-ineligible |
