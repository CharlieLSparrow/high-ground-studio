...
require_text "$isolated_release_runner" 'candidate | release | beta | recover_candidate | seal_candidate | upload_qualified' "Isolated release accepts artifact recovery, proof sealing, and sealed-candidate upload reuse"
require_text "$fastlane_runner" 'candidate|release|beta|recover_candidate|seal_candidate|upload_qualified' "Pinned Capture runner accepts artifact recovery, proof sealing, and sealed-candidate upload reuse"
