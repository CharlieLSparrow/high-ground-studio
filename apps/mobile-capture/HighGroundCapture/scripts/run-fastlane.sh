...
[[ "$#" -ge 1 ]] || fail "Usage: $0 <verify|verify_ui_evidence|ui_test|merge_ui_evidence|candidate|release|beta|recover_candidate|seal_candidate|upload_qualified> [fastlane options]"

lane="$1"
shift
case "${lane}" in
  verify|verify_ui_evidence|ui_test|merge_ui_evidence|candidate|release|beta|recover_candidate|seal_candidate|upload_qualified) ;;
