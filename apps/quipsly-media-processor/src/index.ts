...
import { runAudioTreatmentCloudWorker } from "./audio-treatment-cloud-worker.js";
...
try {
  ...
  const audioTreatmentResults = await runLane("audio-treatment", () =>
    runAudioTreatmentCloudWorker(
      storage,
      new FfmpegAudioMasteringEngine(),
      workerOptions,
      jobLimit,
