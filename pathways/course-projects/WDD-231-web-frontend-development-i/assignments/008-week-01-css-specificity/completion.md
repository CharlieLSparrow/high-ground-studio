...
> Study-example draft for **WDD 231 008: CSS Specificity**.
...
- Source: https://byui-cse.github.io/wdd231-ww-course/week01/prepare-specificity.html

## What This Example Should Demonstrate

W01 Learning Activity: CSS Specificity 1 ID selector (#sub-menu) — 0 1 0 0 1 class selector (.nav) — 0 0 1 0
