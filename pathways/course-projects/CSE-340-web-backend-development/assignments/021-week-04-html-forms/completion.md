...
> Study-example draft for **CSE 340 021: HTML Forms**.
...
- Source: https://byui-cse.github.io/cse340-ww-course/week04/prepare-1-html-forms.html

## What This Example Should Demonstrate

Learning Activity (1 of 2): HTML Forms HTTP Request Methods: GET and POST [HTTP Request Methods: GET and POST: https://www.w3schools.com/tags/ref_httpmethods.asp] Name-Value Pairs [Name-Value Pairs: https://en.wikipedia.org/wiki/Name%E2%80%93value_pair]
