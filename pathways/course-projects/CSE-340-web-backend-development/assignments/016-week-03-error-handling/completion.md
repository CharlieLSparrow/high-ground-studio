...
> Study-example draft for **CSE 340 016: Error Handling**.
...
- Source: https://byui-cse.github.io/cse340-ww-course/week03/prepare-3-error-handling.html

## What This Example Should Demonstrate

Learning Activity (3 of 3): Error Handling An important part of any dynamic web application is to properly handle errors that might emerge. This activity will walk you through proper error handling techniques. Activity Instructions
