...
> Study-example draft for **WDD 130 014: An Introduction to CSS**.
...
- Source: https://byui-cse.github.io/wdd130-ww-course/week02/prepare-css-introduction.html

## What This Example Should Demonstrate

W02 Learning Activity: An Introduction to CSS the background color of all the <h1> elements to dark blue the text color of the content of all the <h1> elements to white
