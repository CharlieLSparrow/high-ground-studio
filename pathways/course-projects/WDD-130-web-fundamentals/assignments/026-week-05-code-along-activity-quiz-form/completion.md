...
> Study-example draft for **WDD 130 026: Code-along Activity: Quiz Form**.
...
- Source: https://byui-cse.github.io/wdd130-ww-course/week05/code-along-quiz-form.html

## What This Example Should Demonstrate

W05 Code-along Activity: Quiz Form Code-along Activity Overview For this activity, you will code along with an instructor video that walks you through each step of the activity below. Make sure that you pause the video, or watch sections over if you need to, so that you are able to complete the entire activity.
