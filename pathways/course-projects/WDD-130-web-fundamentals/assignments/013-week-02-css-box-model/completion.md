...
> Study-example draft for **WDD 130 013: CSS Box Model**.
...
- Source: https://byui-cse.github.io/wdd130-ww-course/week02/prepare-css-box-model.html

## What This Example Should Demonstrate

W02 Learning Activity: CSS Box Model content: This is where the text and images appear. padding: This is the area around the content and separates the content from the border.
