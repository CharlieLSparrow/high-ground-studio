...
> Study-example draft for **WDD 130 018: Code Comments**.
...
- Source: https://byui-cse.github.io/wdd130-ww-course/week03/prepare-commenting.html

## What This Example Should Demonstrate

W03 Learning Activities: Code Comments Comments written in code by developers provide a way to explain the purpose and function of that code. Since the code will need to be maintained and will change, comments can serve as reminders, to-do lists, code snippets, and notes for potential improvements during development. Comments are not processed or...
