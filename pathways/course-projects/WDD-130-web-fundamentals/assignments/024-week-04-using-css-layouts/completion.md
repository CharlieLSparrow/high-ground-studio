...
> Study-example draft for **WDD 130 024: Using CSS Layouts**.
...
- Source: https://byui-cse.github.io/wdd130-ww-course/week04/prepare-layouts.html

## What This Example Should Demonstrate

W04 Learning Activities: Using CSS Layouts Mastering CSS Flex and Grid can be challenging. This activity highlights some of the most relevant layouts and the principles behind them. When do I use CSS Flex versus CSS Grid?
