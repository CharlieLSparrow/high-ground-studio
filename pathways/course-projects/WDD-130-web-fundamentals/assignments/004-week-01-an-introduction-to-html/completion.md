...
> Study-example draft for **WDD 130 004: An Introduction to HTML**.
...
- Source: https://byui-cse.github.io/wdd130-ww-course/week01/prepare-html-introduction.html

## What This Example Should Demonstrate

W01 Learning Activity: An Introduction to HTML Basic page structure <meta charset="utf-8"> : Meta tags contain extra information about a webpage. The charset is used to tell the computer the way the file stores the characters. The standard type of utf-8 is used for almost all webpages.
