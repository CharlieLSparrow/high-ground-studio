...
> Study-example draft for **WDD 130 022: CSS Flex**.
...
- Source: https://byui-cse.github.io/wdd130-ww-course/week04/prepare-css-flex.html

## What This Example Should Demonstrate

W04 Learning Activity: CSS Flex Grid layouts, which will be discussed in another activity, are also used for creating responsive webpages. Flexbox layout is most appropriate for the components of a page, and small-scale layouts, while the Grid layout is intended for larger scale layouts. Open, review, and render the following example application of using...
