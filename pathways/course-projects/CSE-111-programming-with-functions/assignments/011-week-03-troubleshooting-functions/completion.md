...
> Study-example draft for **CSE 111 011: Troubleshooting Functions**.
...
- Source: https://byui-cse.github.io/cse111-ww-course/week03/prepare-2.html

## What This Example Should Demonstrate

W03 Learning Activity (2 of 2): Troubleshooting Functions Run the program and enter input like a user would. Examine the program’s output and discover that the output is incorrect.
