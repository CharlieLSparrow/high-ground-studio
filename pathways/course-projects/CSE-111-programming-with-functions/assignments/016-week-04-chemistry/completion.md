...
> Study-example draft for **CSE 111 016: Chemistry**.
...
- Source: https://byui-cse.github.io/cse111-ww-course/week04/project.html

## What This Example Should Demonstrate

W04 Project: Chemistry Prove that you can write a Python program that creates and uses compound lists. Ask the user for a chemical formula.
