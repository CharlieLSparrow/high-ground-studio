...
> Study-example draft for **CSE 111 020: Final Project Proposal**.
...
- Source: https://byui-cse.github.io/cse111-ww-course/week05/project-proposal.html

## What This Example Should Demonstrate

W05 Assignment: Final Project Proposal Prove that you can write a significant Python program that solves a real-world problem and is well organized with functions. Ideally your program will solve a real-world problem or become a tool in a subject area that interests you, such as chemistry, physics, geography, fashion, family history, linguistics, social...
