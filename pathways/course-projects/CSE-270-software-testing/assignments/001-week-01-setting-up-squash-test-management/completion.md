...
> Study-example draft for **CSE 270 001: Setting up Squash Test Management**.

## Assignment Snapshot

- Course: CSE 270 - Software Testing
- Lesson: Week 01
- Category: Setup/tooling task
- Source: https://byui-cse.github.io/cse270-ww-course/week01/activity_setup.html

## What This Example Should Demonstrate

W01 Activity: Setup Test Management Tools For the next several weeks you will use the Squash test management tool to manage your project requirements, tests, and test results. This tool will be run on your local computer using Docker Desktop. Each student will run their own copy of Squash and configure their project. Squash is one of several test...
