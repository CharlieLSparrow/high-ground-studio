...
> Study-example draft for **CSE 270 009: Tutorial: Test Execution**.
...
- Source: https://byui-cse.github.io/cse270-ww-course/week03/tutorial_test_execution.html

## What This Example Should Demonstrate

Create a test iteration Show the Executions screen by selecting Executions from the left navigating bar. Select the test plan you wish to execute.
