...
> Study-example draft for **CSE 270 015: Fault Injection Test**.
...
- Source: https://byui-cse.github.io/cse270-ww-course/week05/activity_fault_injection_test.html

## What This Example Should Demonstrate

W05 Activity: Fault Injection Test Chaos engineering is used to test and improve the resilience and reliability of software systems. It involves intentionally introducing controlled and measured forms of failure into a system to observe how it responds and to identify potential weaknesses or vulnerabilities. Configure your test environment as follows (If...
