...
> Study-example draft for **CSE 325 002: Organization**.
...
- Source: https://byui-cse.github.io/cse325-ww-course/week01/group-project-01.html

## What This Example Should Demonstrate

Group Project: Group Organization Continue to connect with your group members via MS Teams asynchronously. You will be working with your group on a .NET software development project throughout the course. This initial group assignment is to introduce yourself to your team, identify the strengths of each group member, brainstorm ideas for a web application...
