...
> Study-example draft for **CSE 325 017: Peer Review and Evaluation**.
...
- Source: https://byui-cse.github.io/cse325-ww-course/week07/group-project-peer-review.html

## What This Example Should Demonstrate

Group Project Peer Evaluation The group project peer review is an opportunity for individual group members to rate their group's performance. Review the following instructions on performance factors and complete the review document. Download: Group Project Peer Review Document (.docx) [Group Project Peer Review Document (.docx): https://byui-...
