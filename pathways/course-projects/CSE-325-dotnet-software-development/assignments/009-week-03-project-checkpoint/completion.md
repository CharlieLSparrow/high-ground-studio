...
> Study-example draft for **CSE 325 009: Project Checkpoint**.
...
- Source: https://byui-cse.github.io/cse325-ww-course/week03/group-project-03.html

## What This Example Should Demonstrate

W03 Group: Project Proposal The objective of this group project checkpoint is provide a formalized, group project proposal. Articulate within the .NET Development Ecosystem: The group project has a comprehensive approach to develop a web and/or mobile application using the .NET.
