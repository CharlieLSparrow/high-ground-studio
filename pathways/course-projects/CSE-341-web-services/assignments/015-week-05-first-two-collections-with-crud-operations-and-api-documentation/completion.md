...
> Study-example draft for **CSE 341 015: First Two Collections with Crud Operations and API Documentation**.
...
- Source: https://byui-cse.github.io/cse341-ww-course/week05/project.html

## What This Example Should Demonstrate

W05 Final Project Part 1: First Two Collections with Crud Operations and API Documentation Learning Objectives By the end of this assignment you will be able to do the following:
