...
> Study-example draft for **CSE 210 002: Input and Output**.
...
- Source: https://byui-cse.github.io/cse210-ww-course/week01/csharp-1.html

## What This Example Should Demonstrate

C# Programming Exercise 1: Input and Output Preparation Material This material will outline some of the major differences between C# and Python, highlighting the pieces you'll need to complete this assignment.
