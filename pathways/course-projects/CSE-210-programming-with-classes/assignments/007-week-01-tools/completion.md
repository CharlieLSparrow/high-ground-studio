...
> Study-example draft for **CSE 210 007: Tools**.
...
- Source: https://byui-cse.github.io/cse210-ww-course/week01/prepare-tools.html

## What This Example Should Demonstrate

Git (For getting, tracking, and sharing files) Visual Studio Code, usually called "VS Code" (For writing your programs) The .NET Framework (For building and running your programs)
