...
> Study-example draft for **CSE 110 026: Lists of Numbers**.
...
- Source: https://byui-cse.github.io/cse110-ww-course/week05/code-along.html

## What This Example Should Demonstrate

W05 Code-along Activity: Lists of Numbers Code-along Activity Overview For this activity, you will code along with an instructor video that walks you through each step of the activity below. Make sure that you pause the video, or watch sections over if you need to, so that you are able to complete the entire activity.
