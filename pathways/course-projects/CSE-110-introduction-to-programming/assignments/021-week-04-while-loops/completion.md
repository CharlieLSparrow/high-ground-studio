...
> Study-example draft for **CSE 110 021: While Loops**.
...
- Source: https://byui-cse.github.io/cse110-ww-course/week04/prepare-1-while-loops.html

## What This Example Should Demonstrate

W04 Learning Activity (1 of 3): While Loops Preparation Material There are two types of loops in Python, while loops and for loops. This learning activity will focus on while loops and the next learning activity will focus on for loops.
