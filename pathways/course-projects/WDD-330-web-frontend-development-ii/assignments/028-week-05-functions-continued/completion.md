...
> Study-example draft for **WDD 330 028: Functions Continued**.
...
- Source: https://byui-cse.github.io/wdd330-ww-course/week05/prepare-functions-2.html

## What This Example Should Demonstrate

W05 Learning Activity: Advanced Function Concepts Immediately Invoked Function Expressions (IIFE) This example comes from a previous learning activity using the free REST API service, jsonplaceholder.typicode.com. [previous learning activity: https://byui-cse.github.io/wdd330-ww-course/week03/prepare-apis.html]
