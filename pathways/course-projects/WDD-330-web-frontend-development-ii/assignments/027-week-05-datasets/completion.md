...
> Study-example draft for **WDD 330 027: Datasets**.
...
- Source: https://byui-cse.github.io/wdd330-ww-course/week05/prepare-dataset.html

## What This Example Should Demonstrate

W05 Learning Activity: Dataset Activity Instructions This activity will teach you how to embed structured data into HTML elements using data-* attributes and access that data using JavaScript to build interactive behavior and CSS to style elements based on that data.
