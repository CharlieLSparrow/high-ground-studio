...
> Study-example draft for **WDD 330 011: Template Element**.
...
- Source: https://byui-cse.github.io/wdd330-ww-course/week02/prepare-content-template.html

## What This Example Should Demonstrate

W02 Learning Activity: Template Element Optional Resources The Content Template Element – MDN [The Content Template Element: https://developer.mozilla.org/en-US/docs/Web/HTML/Element/template]
