...
> Study-example draft for **WDD 330 018: Third-Party APIs**.
...
- Source: https://byui-cse.github.io/wdd330-ww-course/week03/prepare-apis.html

## What This Example Should Demonstrate

W03 Learning Activity: Third-Party APIs API Endpoints: The specific URLs where the API can be accessed. HTTP Methods: The methods used to interact with the API, such as GET, POST, PUT, and DELETE.
