...
> Study-example draft for **WDD 330 013: Native Browser APIs**.
...
- Source: https://byui-cse.github.io/wdd330-ww-course/week02/prepare-web-apis.html

## What This Example Should Demonstrate

W02 Learning Activity: Native Browser Web APIs This learning activity focuses on some of those Web APIs supported in modern browsers and in the Node.js runtime. Storage API (session)
