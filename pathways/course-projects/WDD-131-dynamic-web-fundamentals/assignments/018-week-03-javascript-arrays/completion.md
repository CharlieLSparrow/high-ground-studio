...
> Study-example draft for **WDD 131 018: JavaScript Arrays**.
...
- Source: https://byui-cse.github.io/wdd131-ww-course/week03/prepare-arrays-and-array-methods.html

## What This Example Should Demonstrate

W03 Learning Activity: JavaScript Arrays scores[0] = 99; // This assignment expression changed the first score in the array from 100 to 99. Reference JavaScript Arrays Reference – MDN [JavaScript Arrays Reference: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array]
