...
> Study-example draft for **WDD 131 028: HTML Tables**.
...
- Source: https://byui-cse.github.io/wdd131-ww-course/week04/prepare-tables.html

## What This Example Should Demonstrate

W04 Learning Activity: HTML Tables Develop responsive web pages that follow best practices and use valid HTML and CSS. The markup becomes bloated, which can cause confusion and make it hard to maintain and debug the page. There are better choices.
