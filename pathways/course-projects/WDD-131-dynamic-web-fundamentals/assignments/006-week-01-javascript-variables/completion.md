...
> Study-example draft for **WDD 131 006: JavaScript Variables**.
...
- Source: https://byui-cse.github.io/wdd131-ww-course/week01/prepare-variables.html

## What This Example Should Demonstrate

W01 Learning Activity: JavaScript Variables Storing the information you need — Variables – MDN [Storing the information you need — Variables: https://developer.mozilla.org/en-US/docs/Learn/JavaScript/First_steps/Variables] JavaScript data types and data structures – MDN [JavaScript data types and data structures: https://developer.mozilla.org/en-...
