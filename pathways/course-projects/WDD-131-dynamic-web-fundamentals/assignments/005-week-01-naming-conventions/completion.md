...
> Study-example draft for **WDD 131 005: Naming Conventions**.
...
- Source: https://byui-cse.github.io/wdd131-ww-course/week01/prepare-naming-conventions.html

## What This Example Should Demonstrate

W01 Learning Activity: Naming Conventions The file and folder naming conventions outlined in this lesson will be considered 'best-practice' rules for this course. These rules should be applied to all files and folders created in your course work. Use all lowercase syntax such as products.html
