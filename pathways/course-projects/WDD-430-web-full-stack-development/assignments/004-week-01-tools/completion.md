...
> Study-example draft for **WDD 430 004: Tools**.
...
- Source: https://byui-cse.github.io/wdd430-ww-course/week01/setup-course-tools.html

## What This Example Should Demonstrate

Setup: Development Environment This setup activity will prepare you with the development tools and services necessary to complete the assigned activities and projects in the course. Visual Studio Code – Verify that you have an up-to-date, working instance of VS Code running and install or update as needed. [Visual Studio Code: https://code.visualstudio.com]
