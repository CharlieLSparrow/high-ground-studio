...
> Study-example draft for **WDD 430 002: Team Organization**.
...
- Source: https://byui-cse.github.io/wdd430-ww-course/week01/group-project-01.html

## What This Example Should Demonstrate

Group Project: Group Organization Continue to connect with your group members via MS Teams asynchronously. You will be working with a group on a common development project using Next.js through week 5 of the course. This initial group assignment is to introduce yourself to your team, identify the strengths of each group member, review the project's...
