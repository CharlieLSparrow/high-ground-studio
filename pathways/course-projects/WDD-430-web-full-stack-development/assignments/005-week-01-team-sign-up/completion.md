...
> Study-example draft for **WDD 430 005: Team Sign-up**.
...
- Source: https://byui-cse.github.io/wdd430-ww-course/week01/setup-teams.html

## What This Example Should Demonstrate

In this setup activity, you will sign up for a group in Canvas based upon your preferred weekly meeting time and then you will connect via the MS Teams platform. Group Selection in Canvas In Canvas, select the People link in the course menu.
