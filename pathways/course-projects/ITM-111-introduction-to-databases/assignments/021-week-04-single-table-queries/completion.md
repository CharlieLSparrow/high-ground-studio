...
> Study-example draft for **ITM 111 021: Single Table Queries**.
...
- Source: https://byui-cse.github.io/itm111-ww-course/week04/assignment-single-table-queries.html

## What This Example Should Demonstrate

W04 Assignment: Single Table Queries Purpose: Create queries to retrieve specific data from a table in the database. Task: Code single table queries using clauses, keywords, operators and functions.
