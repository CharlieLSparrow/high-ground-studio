...
const verificationSteps = [
  ...
  {
    label: "Studio Cut shared room helper test",
    command: "node",
    args: [
      "--experimental-strip-types",
      "--test",
      "scripts/studio-cut-shared-room.test.mjs",
    ],
  },
  {
    label: "Studio Cut sync review helper test",
    command: "pnpm",
    args: ["studio-cut:sync-review-test"],
  },
  {
  ...
  {
    label: "Studio Cut transcript review test",
    command: "pnpm",
    args: ["studio-cut:transcript-review-test"],
  },
  {
