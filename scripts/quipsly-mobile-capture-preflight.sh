...
node --check "${ROOT_DIR}/scripts/quipsly-clean-generated-smoke-artifacts.mjs"
node --check "${ROOT_DIR}/scripts/quipsly-clean-generated-smoke-artifacts.test.mjs"
...
bash -n "${ROOT_DIR}/scripts/test-capture-support-snapshot.sh"
node --check "${ROOT_DIR}/scripts/quipsly-ios-capture-durability-contract.test.mjs"
node --check "${ROOT_DIR}/scripts/quipsly-ios-capture-source-evidence.test.mjs"
node --check "${ROOT_DIR}/scripts/quipsly-ios-capture-account-isolation.test.mjs"
node --check "${ROOT_DIR}/scripts/quipsly-ios-coordinated-podcast-capture.test.mjs"
node --check "${ROOT_DIR}/scripts/quipsly-ios-episode-manuscript.test.mjs"
node --check "${ROOT_DIR}/scripts/quipsly-ios-rehearsal-readiness.test.mjs"
node --check "${ROOT_DIR}/scripts/quipsly-ios-shared-episode-watch.test.mjs"
node --check "${ROOT_DIR}/scripts/quipsly-verify-hgo-native-watch.mjs"
node --check "${ROOT_DIR}/scripts/quipsly-verify-hgo-native-watch.test.mjs"
...
node --test "${ROOT_DIR}/scripts/quipsly-clean-generated-smoke-artifacts.test.mjs"
...
bash "${ROOT_DIR}/scripts/test-capture-support-snapshot.sh"
bash "${IOS_DIR}/scripts/test-source-plan-projection.sh"
bash "${IOS_DIR}/scripts/test-video-capture-quality-policy.sh"
bash "${IOS_DIR}/scripts/test-capture-attention-presentation.sh"
bash "${IOS_DIR}/scripts/test-on-device-transcript-delivery-policy.sh"
bash "${IOS_DIR}/scripts/test-on-device-transcript-ledger-policy.sh"
node "${ROOT_DIR}/scripts/quipsly-ios-capture-durability-contract.test.mjs"
node "${ROOT_DIR}/scripts/quipsly-ios-capture-source-evidence.test.mjs"
node "${ROOT_DIR}/scripts/quipsly-ios-capture-account-isolation.test.mjs"
node "${ROOT_DIR}/scripts/quipsly-ios-coordinated-podcast-capture.test.mjs"
node "${ROOT_DIR}/scripts/quipsly-ios-episode-manuscript.test.mjs"
node "${ROOT_DIR}/scripts/quipsly-ios-rehearsal-readiness.test.mjs"
node "${ROOT_DIR}/scripts/quipsly-ios-shared-episode-watch.test.mjs"
node --test "${ROOT_DIR}/scripts/quipsly-verify-hgo-native-watch.test.mjs"
