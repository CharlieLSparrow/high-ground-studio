...
QUIPSLY_GA_PROPERTY_ID="${QUIPSLY_GA_PROPERTY_ID:-503353241}"
...
if [[ ! "${QUIPSLY_GA_PROPERTY_ID}" =~ ^[0-9]{6,20}$ ]]; then
  echo "QUIPSLY_GA_PROPERTY_ID must be a numeric GA4 property ID." >&2
  exit 2
fi
