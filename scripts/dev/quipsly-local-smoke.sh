...
check_contains "/login?callbackUrl=%2Fprojects&inviteToken=qinv_testtoken" "Use the email address that received this invite"
check_contains "/login?callbackUrl=%2Fprojects&inviteToken=qinv_testtoken" "Continue with Google"
check_contains "/login?callbackUrl=%2Fprojects&inviteToken=qinv_testtoken" "Create account"
check_contains "/projects" "Nests hold the work. Documents hold the text."
check_contains "/projects" "Create a Nest"
check_contains_any "/coaching" "Your coaching work continues here" "Sign in to coaching" "Quipsly Nest" "Sign in to Nest" "Your private creative workspace lives here"
check_contains_any "/coaching/sessions" "Your coaching work continues here" "Sign in to coaching" "Prepare, capture, transcribe, and follow through" "Your coaching session" "Quipsly Nest" "Sign in to Nest" "Your private creative workspace lives here"
