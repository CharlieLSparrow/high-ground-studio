...
test("retained native task-evidence merge proves immutable task state, replay, and source return", async () => {
  ...
  assert.match(runtimeTests, /CapturePacketTaskGovernance_/);
  assert.match(runtimeTests, /CaptureTodayTaskMergedEvidenceGovernance_/);
  ...
  assert.match(nativeReview, /CapturePacketTaskGovernance_/);
  assert.match(phoneShell, /CaptureTodayTaskMergedEvidenceSource_/);
  assert.match(phoneShell, /CaptureTodayTaskMergedEvidenceGovernance_/);
