...
assert.match(operation, /quipsly\.session\.transcript-note\.materialize/);
...
assert.match(operation, /noteGovernance\.actionId === governedNote\.id/);
assert.match(operation, /initialRevision\?\.snapshotJson/);
...
assert.match(runtimeTests, /CapturePacketNoteGovernance_/);
